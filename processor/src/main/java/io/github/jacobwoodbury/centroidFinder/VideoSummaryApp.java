...
public class VideoSummaryApp {
     ...
     *
     * Usage: java VideoSummaryApp <input_path> <outputCsv> <hex_target_color>
     * <threshold>
     *
     * Arguments:
     * - input_path: Path to the source video file.
     * - outputCsv: Path where the output CSV will be written.
     * - hex_target_color: The target RGB color in hex format (e.g., FF0000 for
     * red).
